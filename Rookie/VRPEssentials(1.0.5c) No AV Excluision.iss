...
#define MyAppVersion "1.0.5c(NO Auto AV exclusion)"
...
AppId={{CE8D33DF-0CD0-459B-B603-FBE261627D91}
AppName={#MyAppName}
...
OutputBaseFilename=VRP Essentials 1.0.5c(NO AUTO AV EXCLUSION)
